...
- [x] Verify observability defaults (structured logs + metrics export) remain compatible.
...
- [x] Confirm release runbook and maintainer runbook reflect final `v1.0` process.
